  ...
  function createLayoutFirstController(doc, options = {}) {
    ...
    function placeVideoFile(zone, file) {
      ...
      if (typeof wrap.setAttribute === "function") {
        ...
        // instead of only dragging it with a mouse (WCAG 2.1.1). aria-keyshortcuts must advertise
        // every key the keydown handler below acts on — the arrows move/swap AND Delete/Backspace
        // removes — or a screen-reader user is never told the removal shortcut exists.
        ...
        wrap.setAttribute("aria-label", slotName(zone) + " video — drag, or focus and press the arrow keys to move or swap it between slots, or Delete to remove it");
      }
